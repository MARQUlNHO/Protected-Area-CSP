...
public class ProtectedArea {
    ...
    public boolean isInside(double x, double y, double z, String dimension) {
        if (!this.dimension.equals(dimension)) {
            String mapped = mapWorldNameToDimension(this.worldName);
            if (!mapped.equals(dimension)) return false;
        }
    ...
    public boolean isInside(double x, double y, double z, String worldName, String worldDimension) {
        return isInside(x, y, z, worldDimension);
    }

    private static String mapWorldNameToDimension(String worldName) {

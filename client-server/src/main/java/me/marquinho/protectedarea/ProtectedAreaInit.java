...
import me.marquinho.protectedarea.listeners.*;
import me.marquinho.protectedarea.managers.*;
...
public class ProtectedAreaInit {
    ...
    public void onInitialize() {
        ...
        ServerPlayConnectionEvents.DISCONNECT.register((handler, sv) -> {
            ...
            if (wandManager != null)
                wandManager.removePlayer(handler.player.getUuid());
        });

        AreaProtectionListener.register(this);
        WandListener.register(this);

...
import me.marquinho.protectedarea.managers.NotificationManager;
...
public class AreaProtectionListener {
    ...
    public static void register(ProtectedAreaInit plugin) {
        ...
        PlayerBlockBreakEvents.BEFORE.register((world, player, pos, state, entity) -> {
            ...
            if (plugin.getAreaManager().hasInheritedException(dim, pos.getX(), pos.getY(), pos.getZ(), sPlayer.getGameProfile().getName(), "no_break")) return true;
            ...
            if (plugin.getAreaManager().hasInheritedRule(dim, pos.getX(), pos.getY(), pos.getZ(), AreaRule.NO_BREAK)) {
                if (plugin.getAreaManager().hasInheritedAdvancedBlock(dim, pos.getX(), pos.getY(), pos.getZ(), AdvancedRuleType.YES_BREAK, blockId)) return true;
        ...
        UseBlockCallback.EVENT.register((player, world, hand, hitResult) -> {
            ...
            if (stack.getItem() instanceof BucketItem) {
                ...
                if (plugin.getAreaManager().hasInheritedException(dim, pos.getX(), pos.getY(), pos.getZ(), sPlayer.getGameProfile().getName(), "no_place")) return ActionResult.PASS;
                ...
                if (plugin.getAreaManager().hasInheritedRule(dim, pos.getX(), pos.getY(), pos.getZ(), AreaRule.NO_PLACE)) {
                    if (plugin.getAreaManager().hasInheritedAdvancedBlock(dim, pos.getX(), pos.getY(), pos.getZ(), AdvancedRuleType.YES_PLACE, fluidId)) return ActionResult.PASS;
            ...
            ProtectedArea area = plugin.getAreaManager().getAreaAt(dim, pos.getX(), pos.getY(), pos.getZ());
            if (area == null) return ActionResult.PASS;
            if (plugin.getAreaManager().hasInheritedException(dim, pos.getX(), pos.getY(), pos.getZ(), sPlayer.getGameProfile().getName(), "no_interact")) return ActionResult.PASS;
            ...
            if (plugin.getAreaManager().hasInheritedRule(dim, pos.getX(), pos.getY(), pos.getZ(), AreaRule.NO_INTERACT)) {
                if (plugin.getAreaManager().hasInheritedAdvancedBlock(dim, pos.getX(), pos.getY(), pos.getZ(), AdvancedRuleType.YES_INTERACT, blockId)) return ActionResult.PASS;
        ...
        UseEntityCallback.EVENT.register((player, world, hand, entity, hitResult) -> {
            ...
            if (area == null) return ActionResult.PASS;
            if (plugin.getAreaManager().hasInheritedException(dim, ex, ey, ez, sPlayer.getGameProfile().getName(), "no_interact")) return ActionResult.PASS;
            ...
            if (plugin.getAreaManager().hasInheritedRule(dim, ex, ey, ez, AreaRule.NO_INTERACT)) {
                if (plugin.getAreaManager().hasInheritedAdvancedEntity(dim, ex, ey, ez, AdvancedRuleType.YES_INTERACT, entityId)) return ActionResult.PASS;
        ...
        AttackEntityCallback.EVENT.register((player, world, hand, entity, hitResult) -> {
            ...
            if (entity instanceof ServerPlayerEntity) {
                if (plugin.getAreaManager().hasInheritedException(dim, ex, ey, ez, attackerName, "no_pvp")) return ActionResult.PASS;
            ...
            if (plugin.getAreaManager().hasInheritedException(dim, ex, ey, ez, attackerName, "no_entityattack")) return ActionResult.PASS;
        ...
        ServerLivingEntityEvents.ALLOW_DAMAGE.register((entity, source, amount) -> {
            ...
            if (area == null) return true;
            if (plugin.getAreaManager().hasInheritedException(dim, sPlayer.getX(), sPlayer.getY(), sPlayer.getZ(), sPlayer.getGameProfile().getName(), "no_damage")) return true;
    ...
    public boolean onBlockPlace(ServerPlayerEntity player, ServerWorld world, BlockPos pos, String blockId) {
        ...
        ProtectedArea area = plugin.getAreaManager().getAreaAt(dim, pos.getX(), pos.getY(), pos.getZ());
        if (area == null) return true;
        if (plugin.getAreaManager().hasInheritedException(dim, pos.getX(), pos.getY(), pos.getZ(), player.getGameProfile().getName(), "no_place")) return true;
        ...
        if (plugin.getAreaManager().hasInheritedRule(dim, pos.getX(), pos.getY(), pos.getZ(), AreaRule.NO_PLACE)) {
            if (plugin.getAreaManager().hasInheritedAdvancedBlock(dim, pos.getX(), pos.getY(), pos.getZ(), AdvancedRuleType.YES_PLACE, blockId)) return true;
    ...
    public boolean onItemDrop(ServerPlayerEntity player, String itemId) {
        ...
        if (area == null) return true;
        if (plugin.getAreaManager().hasInheritedException(dim, player.getX(), player.getY(), player.getZ(), player.getGameProfile().getName(), "no_drop")) return true;
        ...
        if (plugin.getAreaManager().hasInheritedRule(dim, player.getX(), player.getY(), player.getZ(), AreaRule.NO_DROP)) {
            if (plugin.getAreaManager().hasInheritedAdvancedItem(dim, player.getX(), player.getY(), player.getZ(), AdvancedRuleType.YES_DROP, itemId)) return true;
    ...
    public boolean onItemPickup(ServerPlayerEntity player, ItemEntity itemEntity, String itemId) {
        ...
        if (plugin.getAreaManager().hasInheritedException(dim, player.getX(), player.getY(), player.getZ(), player.getGameProfile().getName(), "no_collect")) return true;
        ...
        if (plugin.getAreaManager().hasInheritedRule(dim, player.getX(), player.getY(), player.getZ(), AreaRule.NO_COLLECT)) {
            if (plugin.getAreaManager().hasInheritedAdvancedItem(dim, player.getX(), player.getY(), player.getZ(), AdvancedRuleType.YES_COLLECT, itemId)) return true;
            notifyPickupOnce(player, itemEntity, () ->

package me.marquinho.protectedarea.client.models;
...
public class ProtectedArea {
    ...
    public ProtectedArea(String id, String dimension,
    ...
    public boolean isWithinFlatBounds(double x, double y, double z, String worldDimension) {
        if (!this.dimension.equals(worldDimension)) return false;
    ...
    public boolean isWithinFlatRect(double x, double y, double z, String worldDimension) {
        if (!this.dimension.equals(worldDimension)) return false;
        return switch (getFlatAxis()) {

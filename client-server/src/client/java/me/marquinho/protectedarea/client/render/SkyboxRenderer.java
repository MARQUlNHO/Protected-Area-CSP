package me.marquinho.protectedarea.client.render;
...
public class SkyboxRenderer {
    ...
    private static Identifier getOrLoadTexture(String skyboxName) {
        ...
        if (!file.exists()) {
            System.err.println("[ProtectedArea] Skybox not found: " + file.getAbsolutePath());
        ...
        try (FileInputStream stream = new FileInputStream(file)) {
            ...
            System.out.println("[ProtectedArea] Skybox loaded: " + skyboxName);
            return id;
        } catch (IOException e) {
            System.err.println("[ProtectedArea] Error loading skybox '" + skyboxName + "': " + e.getMessage());
            textureCache.put(skyboxName, null);
            return null;
        }
    }

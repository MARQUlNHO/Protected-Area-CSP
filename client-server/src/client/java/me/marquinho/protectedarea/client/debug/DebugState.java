...
public class DebugState {
    ...
    private int totalDimensionAreas = 0;
    private String dimensionKey = "";
    private int dimensionPriority = 0;
    private String dimensionSkybox = "";
    ...
    public void deactivate() {
        ...
        this.currentAreaId = "";
        this.totalAreas  = 0;
        this.debugType   = TYPE_CUBE;
        this.totalDimensionAreas = 0;
        this.dimensionKey = "";
        this.dimensionPriority = 0;
        this.dimensionSkybox = "";
        this.rules.clear();
    ...
    public void toggleDebugType() {
        if (TYPE_CUBE.equals(debugType))      debugType = TYPE_FLAT;
        else if (TYPE_FLAT.equals(debugType)) debugType = TYPE_DIMENSION;
        else                                  debugType = TYPE_CUBE;
        currentPage = PAGE_OVERVIEW;
    }

    public boolean isDimensionType() { return TYPE_DIMENSION.equals(debugType); }
    public boolean isFlatType()      { return TYPE_FLAT.equals(debugType); }

    public int nextPage() {
        if (isFlatType()) return currentPage;
    ...
    public void applyDimensionOverviewData(String currentAreaId, int totalDimensionAreas, String dimensionKey,
                                           int dimensionPriority, String dimensionSkybox, int totalPages) {
        this.currentAreaId       = currentAreaId;
        this.totalPages          = totalPages;
        this.totalDimensionAreas = totalDimensionAreas;
        this.dimensionKey        = dimensionKey;
        this.dimensionPriority   = dimensionPriority;
        this.dimensionSkybox     = dimensionSkybox;
    }

    public int getTotalDimensionAreas() { return totalDimensionAreas; }
    public String getDimensionKey()     { return dimensionKey; }
    public int getDimensionPriority()   { return dimensionPriority; }
    public String getDimensionSkybox()  { return dimensionSkybox; }
